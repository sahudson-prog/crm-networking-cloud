...
- En cloud, `contactSyncApply.ts` debe validar correos y telefonos antes de crear contactos desde `Nuevos` o `Duplicados complejos`; si un dato ya pertenece a otro contacto, debe fallar antes de insertar `contacts`, sin dejar fichas locales vacias o sin ID externo.
