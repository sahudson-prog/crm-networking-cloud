-- Coffeecito PROD bootstrap: canonical global headhunter master.
-- Contains 62 companies and 64 reviewed domain mappings.
--
-- This query writes to:
-- - public.headhunter_companies
-- - public.headhunter_company_domains
--
-- Safe to rerun. Existing companies/domains are preserved by unique indexes.
...
inserted_companies as (
  ...
  select
    cc.display_name,
    cc.normalized_name,
    'Maestro canonico Coffeecito.' as notes
